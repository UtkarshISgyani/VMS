...
namespace API.Controllers
{
    ...
    public class LibraryController : ControllerBase
    {
            ...
            firstFineEmails.ForEach(x =>
            {
                ...
                <html>
                    <body>
                        ...
                        <h4>Your service order: "{x.Book?.Title}".</h4>
                        <h4>is Pending.</h4>
                        <h4>We will complete it as soon as possible.</h4>
                        <h4>Thanks</h4>
                    </body>
                </html>
                """;

                EmailService.SendEmail(x.User!.Email, "Pending Orders", body);
            });
        ...
        public ActionResult BlockFineOverdueUsers()
        {
            ...
            var users = emailsWithFine.Where(x => x.FinePaid >= 0).Select(x => x.User!).Distinct().ToList();
